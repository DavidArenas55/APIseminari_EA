...
import subjectRoutes from './subjects/subject_routes.js'; // Importamos las rutas de Subjects
...
const swaggerOptions = {
    ...
    apis: ['./modules/users/*.js', './modules/forum/*.js', './subjects/*.js'] // Asegúrate de que esta ruta apunta a tus rutas
};
...
//mongoose;
mongoose
    .connect(process.env.MONGODB_URI || 'mongodb+srv://David:Claudia1309@cluster0.yylqd.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0')
